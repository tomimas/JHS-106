...
(deftest shouldMatchFullStreet
  (testing "full street"
    ...
    (is (= ["Rosvokatu 21-23" "Rosvokatu " "21" nil "23" nil nil  nil nil] (re-matches street "Rosvokatu 21-23")))
    (is (= ["Urhean Rosvon katu 1" "Urhean Rosvon katu " "1" nil nil nil nil nil nil] (re-matches street "Urhean Rosvon katu 1")))
    (is (= ["Urhean Rosvon katu 1d" "Urhean Rosvon katu " "1" "d" nil nil nil nil nil] (re-matches street "Urhean Rosvon katu 1d")))
    (is (= ["Urhean Rosvon katu 4-6" "Urhean Rosvon katu " "4" nil "6" nil nil nil nil] (re-matches street "Urhean Rosvon katu 4-6"))))
  (testing "full street with stairway"
    (is (= ["Rosvokatu 1 B" "Rosvokatu " "1" nil nil nil "B" nil nil] (re-matches street "Rosvokatu 1 B"))))
  (testing "full street with apartment"
    (is (= ["Rosvokatu 1 B 1" "Rosvokatu " "1" nil nil nil "B" "1" nil] (re-matches street "Rosvokatu 1 B 1")))
    (is (= ["Rosvokatu 1 as 1" "Rosvokatu " "1" nil nil nil "as" "1" nil] (re-matches street "Rosvokatu 1 as 1")))
    (is (= ["Rosvokatu 1 as. 1" "Rosvokatu " "1" nil nil nil "as." "1" nil] (re-matches street "Rosvokatu 1 as. 1")))
    (is (= ["Rosvokatu 1 bst 1" "Rosvokatu " "1" nil nil nil "bst" "1" nil] (re-matches street "Rosvokatu 1 bst 1")))
    (is (= ["Rosvokatu 1 bst. 1" "Rosvokatu " "1" nil nil nil "bst." "1" nil] (re-matches street "Rosvokatu 1 bst. 1")))
  ...
  (testing "full street with leading zeroes in apartment number"
    (is (= ["Rosvokatu 1 B 001" "Rosvokatu " "1" nil nil nil "B" "1" nil] (re-matches street "Rosvokatu 1 B 001")))
    (is (= ["Rosvokatu 1 b 001" "Rosvokatu " "1" nil nil nil "b" "1" nil] (re-matches street "Rosvokatu 1 b 001")))
    (is (= ["Rosvokatu 1 as 001" "Rosvokatu " "1" nil nil nil "as" "1" nil] (re-matches street "Rosvokatu 1 as 001")))
    (is (= ["Rosvokatu 1 as. 001" "Rosvokatu " "1" nil nil nil "as." "1" nil] (re-matches street "Rosvokatu 1 as. 001")))
    (is (= ["Rosvokatu 1 bst 001" "Rosvokatu " "1" nil nil nil "bst" "1" nil] (re-matches street "Rosvokatu 1 bst 001")))
    (is (= ["Rosvokatu 1 bst. 001" "Rosvokatu " "1" nil nil nil "bst." "1" nil] (re-matches street "Rosvokatu 1 bst. 001")))
    (is (= ["Rosvokatu 1 B 001c" "Rosvokatu " "1" nil nil nil "B" "1" "c"] (re-matches street "Rosvokatu 1 B 001c")))
    (is (= ["Rosvokatu 1 b 001c" "Rosvokatu " "1" nil nil nil "b" "1" "c"] (re-matches street "Rosvokatu 1 b 001c")))
    (is (= ["Rosvokatu 1 as 001c" "Rosvokatu " "1" nil nil nil "as" "1" "c"] (re-matches street "Rosvokatu 1 as 001c")))
    (is (= ["Rosvokatu 1 as. 001c" "Rosvokatu " "1" nil nil nil "as." "1" "c"] (re-matches street "Rosvokatu 1 as. 001c")))
    (is (= ["Rosvokatu 1 bst 001c" "Rosvokatu " "1" nil nil nil "bst" "1" "c"] (re-matches street "Rosvokatu 1 bst 001c")))
    (is (= ["Rosvokatu 1 bst. 001c" "Rosvokatu " "1" nil nil nil "bst." "1" "c"] (re-matches street "Rosvokatu 1 bst. 001c"))))
  (testing "address with multiple buildings on same plot"
    (is (= ["Ulvilantie 29/4 K 825" "Ulvilantie " "29" nil nil "4" "K" "825" nil] (re-matches street "Ulvilantie 29/4 K 825")))
    (is (= ["Ulvilantie 29/4 k 825" "Ulvilantie " "29" nil nil "4" "k" "825" nil] (re-matches street "Ulvilantie 29/4 k 825")))
    (is (= ["Ulvilantie 29 rak. 4 K 825" "Ulvilantie " "29" nil nil "4" "K" "825" nil] (re-matches street "Ulvilantie 29 rak. 4 K 825")))
    (is (= ["Ulvilantie 29 rak. 4 k 825" "Ulvilantie " "29" nil nil "4" "k" "825" nil] (re-matches street "Ulvilantie 29 rak. 4 k 825")))
    (is (= ["Ulvilantie 29 rak 4 K 825" "Ulvilantie " "29" nil nil "4" "K" "825" nil] (re-matches street "Ulvilantie 29 rak 4 K 825")))
    (is (= ["Ulvilantie 29 rak 4 k 825" "Ulvilantie " "29" nil nil "4" "k" "825" nil] (re-matches street "Ulvilantie 29 rak 4 k 825")))
    (is (= ["Ulvilantie 29a/4 K 825" "Ulvilantie " "29" "a" nil "4" "K" "825" nil] (re-matches street "Ulvilantie 29a/4 K 825")))
    (is (= ["Ulvilantie 29a/4 K 825c" "Ulvilantie " "29" "a" nil "4" "K" "825" "c"] (re-matches street "Ulvilantie 29a/4 K 825c")))
    (is (= ["Ulvilantie 29A/4 k 825" "Ulvilantie " "29" "A" nil "4" "k" "825" nil] (re-matches street "Ulvilantie 29A/4 k 825")))
    (is (= ["Ulvilantie 29A/4 k 825C" "Ulvilantie " "29" "A" nil "4" "k" "825" "C"] (re-matches street "Ulvilantie 29A/4 k 825C")))
    (is (= ["Ulvilantie 29a rak. 4 K 825" "Ulvilantie " "29" "a" nil "4" "K" "825" nil] (re-matches street "Ulvilantie 29a rak. 4 K 825")))
    (is (= ["Ulvilantie 29a rak 4 K 825" "Ulvilantie " "29" "a" nil "4" "K" "825" nil] (re-matches street "Ulvilantie 29a rak 4 K 825")))
    (is (= ["Ulvilantie 29A rak 4 k 825c" "Ulvilantie " "29" "A" nil "4" "k" "825" "c"] (re-matches street "Ulvilantie 29A rak 4 k 825c")))
